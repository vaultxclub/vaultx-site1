...
// 📊 Investment tiers (gross % profit per month)
const VAULTX_TIERS = [
...
// 👑 Elite club settings
const ELITE_PRICE = 100;               // monthly subscription (USDT)
const ELITE_RAFFLE_PRIZE_USDT = 200;   // daily raffle prize
const ELITE_RAFFLE_PER_MEMBERS = 120;  // 1 prize for every 120 elite members
